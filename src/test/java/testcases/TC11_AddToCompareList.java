...
public class TC11_AddToCompareList extends TestBase{
    ...
    public void addDifferentProductsToCompare() throws InterruptedException {
        ...
        p08ProductPage.clickItem1AddToCompare();
        Thread.sleep(3000);

        //Assertion1
        Assert.assertTrue(p08ProductPage.isAdded("product comparison"));
